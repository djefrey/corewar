...
const instruction_t INSTRUCTIONS[INSTRUCTIONS_NB] = {
    ...
    {0x05, 10, 3, {REGISTER, REGISTER, REGISTER, NONE},
        &sub_instruction},
    {0x06, 6, 3, {REGISTER | DIRECT | INDIRECT, REGISTER | DIRECT | INDIRECT,
        REGISTER, NONE}, &and_instruction},
    {0x07, 6, 3, {REGISTER | DIRECT | INDIRECT, REGISTER | DIRECT | INDIRECT,
        REGISTER, NONE}, &or_instruction},
    {0x08, 6, 3, {REGISTER | DIRECT | INDIRECT, REGISTER | DIRECT | INDIRECT,
        REGISTER, NONE}, &xor_instruction},
    ...
    {0x0f, 1000, 0, {NONE, NONE, NONE, NONE},
        &lfork_instruction},
    {0x010, 2, 1, {REGISTER, NONE, NONE, NONE},
        &aff_instruction},
};